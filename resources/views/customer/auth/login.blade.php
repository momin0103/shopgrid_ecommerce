        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1 col-12">
                    <form class="card login-form" action="{{route('new-customer-login')}}" method="post">
                        @csrf
                        <div class="card-body">
                            <div class="title">
                                <h3>Login Now</h3>
                            ...
                            <div class="form-group input-group">
                                <label for="reg-fn">Email <span class="text-danger">*</span></label>
                                <input class="form-control" type="email" name="email" id="reg-email" required/>
                            </div>
                            <div class="form-group input-group">
                                <label for="reg-fn">Password <span class="text-danger">*</span></label>
                            ...
                            <div class="d-flex flex-wrap justify-content-between bottom-content">
                                ...
                                <a class="lost-pass" href="{{route('customer-forget-password')}}">Forgot password?</a>
                            </div>
                            <div class="button">
