        ...
        <div class="row">
            <div class="col-md-10 mx-auto">
                <div class="card card-info">
                    ...
                    <!-- form start -->
                    <form class="form-horizontal" action="{{route('update-admin-user', ['id' => $user->id])}}" method="POST">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" class="form-control" id="inputPassword3" value="{{$user->email}}" name="email" placeholder="User Email"/>
