                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                <div class="main-img">
                                    <img class="xzoom" id="xzoom-default" src="{{asset($product->subImage[0]->image)}}" xoriginal="{{asset($product->subImage[0]->image)}}" />
                                </div>
                                <div class="images">
                                    @foreach($product->subImage as $subImage)
                                        <a href="{{asset($subImage->image)}}">
                                            <img class="xzoom-gallery" width="80" src="{{asset($subImage->image)}}"  xpreview="{{asset($subImage->image)}}" xoriginal="{{asset($subImage->image)}}" title="The description goes here"></a>
                                    @endforeach
                                </div>
                            </main>
                        </div>
